...
router
  ...
  .get('/full/current/:userId', tripController.getFullCurrentTrip.bind(tripController)) // Specific route first
  .get('/full/:userId/:tripId', tripController.getFullTripByUserIdAndTripId.bind(tripController)) // General route after
